...
class NfcEngagementActivity : AppCompatActivity() {
    ...
    constructor(
        ...
        private fun parseStaticHandover(
            ...
            transferMethod = when {
                String(carrierRecord.get().type).equals(APPLICATION_BT_LE_OOB, true) -> TransferChannels.BLE
                String(carrierRecord.get().type).equals(APPLICATION_WIFI_AWARE, true) -> TransferChannels.WiFiAware
                String(carrierRecord.get().type).equals(APPLICATION_ISO_MDL, true) -> TransferChannels.NFC
        ...
        private fun extractBluetoothLEInfo(carrierRecord: NdefRecord) {
            ...
            bleServiceMode =
                ...
                } else if (leRole.contentEquals(LE_PERIPHERAL_ONLY) || leRole.contentEquals(LE_PERIPHERAL_PREF)) {
